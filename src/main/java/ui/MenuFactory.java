...
import resources.MetaBuilderResources;
 ...
 * in the specified MetaBuilderResources object, with a key followed by a prefix P.
 * 
...
class MenuFactory
{
	...
	private final MetaBuilderResources aResources;
	
	MenuFactory(MetaBuilderResources pResources)
	{
